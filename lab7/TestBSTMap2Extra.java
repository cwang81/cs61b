...
public class TestBSTMap2Extra {
    ...
    public void testRemoveRoot() {
        BSTMap2<String,String> q = new BSTMap2<String,String>();
        q.put("c","a");
        q.put("b","a");
        q.put("a","a");
        q.put("d","a");
    ...
    public void testRemoveRootEdge() {
        BSTMap2 rightChild = new BSTMap2();
        rightChild.put('A', 1);
        rightChild.put('B', 2);
