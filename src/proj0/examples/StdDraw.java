/******************************************************************************
 *  Compilation:  javac proj0.StdDraw.java
 *  Execution:    java proj0.StdDraw
 *  Dependencies: none
 *
...
/**
 *  The {@code proj0.StdDraw} class provides a basic capability for
 *  creating drawings with your programs. It uses a simple graphics model that
 ...
 *  <p>
 *  <b>Getting started.</b>
 *  To use standard drawing, you must have {@code proj0.StdDraw.class} in your
 *  Java classpath. If you used our autoinstaller, you should be all set.
 *  Otherwise, download
 *  <a href = "https://introcs.cs.princeton.edu/java/stdlib/StdDraw.java">proj0.StdDraw.java</a>
 ...
 *           proj0.StdDraw.setPenRadius(0.05);
 *           proj0.StdDraw.setPenColor(proj0.StdDraw.BLUE);
 *           proj0.StdDraw.point(0.5, 0.5);
 *           proj0.StdDraw.setPenColor(proj0.StdDraw.MAGENTA);
 *           proj0.StdDraw.line(0.2, 0.2, 0.8, 0.2);
 *       }
 *   }
 *  </pre>
 ...
 *  The methods {@code proj0.StdDraw.line()} and {@code proj0.StdDraw.point()}
 *  draw lines and points; the methods {@code proj0.StdDraw.setPenRadius()}
 *  and {@code proj0.StdDraw.setPenColor()} control the line thickness and color.
 *  <p>
 ...
 *  and represented in degrees. For example, {@code proj0.StdDraw.arc(0.0, 0.0, 1.0, 0, 90)}
 ...
 *   proj0.StdDraw.filledPolygon(x, y);
 *  </pre>
 *  <p>
 *  <b>Pen size.</b>
 ...
 *  </ul>
 *  <p>
 *  For example, {@code proj0.StdDraw.setPenRadius(0.025)} makes
 ...
 *  For example, {@code proj0.StdDraw.setPenColor(proj0.StdDraw.MAGENTA)} sets the
 ...
 *  For example, {@code proj0.StdDraw.setCanvasSize(800, 800)}
 ...
 *  leave a small margin, you can call {@code proj0.StdDraw.setScale(-.05, 1.05)}.
 *  <p>
 ...
 *   proj0.StdDraw.setFont(font);
 *   proj0.StdDraw.text(0.5, 0.5, "Hello, World");
 *  </pre>
 *  <p>
 *  <b>Images.</b>
 ...
 *  {@code proj0.StdDraw.clear(proj0.StdDraw.LIGHT_GRAY)} clears the canvas to a shade
 *  of gray.
 *  <p>
 ...
 *  <pre>
 *   proj0.StdDraw.setScale(-2, +2);
 *   proj0.StdDraw.enableDoubleBuffering();
 *
 *   for (double t = 0.0; true; t += 0.02) {
 *       double x = Math.sin(t);
 *       double y = Math.cos(t);
 *       proj0.StdDraw.clear();
 *       proj0.StdDraw.filledCircle(x, y, 0.05);
 *       proj0.StdDraw.filledCircle(-x, -y, 0.05);
 *       proj0.StdDraw.show();
 *       proj0.StdDraw.pause(20);
 *   }
 *  </pre>
 *  <p>
...
public final class StdDraw implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
    ...
    private static proj0.StdDraw std = new proj0.StdDraw();
    ...
    ***************************************************************************/
     ...
     * {@code proj0.StdDraw.BLACK}, {@code proj0.StdDraw.BLUE}, {@code proj0.StdDraw.CYAN},
     * {@code proj0.StdDraw.DARK_GRAY}, {@code proj0.StdDraw.GRAY}, {@code proj0.StdDraw.GREEN},
     * {@code proj0.StdDraw.LIGHT_GRAY}, {@code proj0.StdDraw.MAGENTA}, {@code proj0.StdDraw.ORANGE},
     * {@code proj0.StdDraw.PINK}, {@code proj0.StdDraw.RED}, {@code proj0.StdDraw.WHITE}, and
     * {@code proj0.StdDraw.YELLOW}.
     *
    ...
    ***************************************************************************/
    ...
    private static Image getImage(String filename) {
        ...
        // in case file is inside a .jar (classpath relative to proj0.StdDraw)
        if ((icon == null) || (icon.getImageLoadStatus() != MediaTracker.COMPLETE)) {
            URL url = proj0.StdDraw.class.getResource(filename);
            if (url != null)
                icon = new ImageIcon(url);
        }
...
*/
    ...
    ***************************************************************************/
    ...
    public void actionPerformed(ActionEvent e) {
        FileDialog chooser = new FileDialog(proj0.StdDraw.frame, "Use a .png or .jpg extension", FileDialog.SAVE);
        chooser.setVisible(true);
        String filename = chooser.getFile();
        if (filename != null) {
            proj0.StdDraw.save(chooser.getDirectory() + File.separator + chooser.getFile());
        }
    }
    ...
    ***************************************************************************/
    ...
    public void mousePressed(MouseEvent e) {
        synchronized (mouseLock) {
            mouseX = proj0.StdDraw.userX(e.getX());
            mouseY = proj0.StdDraw.userY(e.getY());
            isMousePressed = true;
        }
    }
    ...
    *  as an argument. It can handle action keys
     ...
     */
    public static void main(String[] args) {
        proj0.StdDraw.square(0.2, 0.8, 0.1);
        proj0.StdDraw.filledSquare(0.8, 0.8, 0.2);
        proj0.StdDraw.circle(0.8, 0.2, 0.2);

        proj0.StdDraw.setPenColor(proj0.StdDraw.BOOK_RED);
        proj0.StdDraw.setPenRadius(0.02);
        proj0.StdDraw.arc(0.8, 0.2, 0.1, 200, 45);

        // draw a blue diamond
        proj0.StdDraw.setPenRadius();
        proj0.StdDraw.setPenColor(proj0.StdDraw.BOOK_BLUE);
        double[] x = { 0.1, 0.2, 0.3, 0.2 };
        double[] y = { 0.2, 0.3, 0.2, 0.1 };
        proj0.StdDraw.filledPolygon(x, y);

        // text
        proj0.StdDraw.setPenColor(proj0.StdDraw.BLACK);
        proj0.StdDraw.text(0.2, 0.5, "black text");
        proj0.StdDraw.setPenColor(proj0.StdDraw.WHITE);
        proj0.StdDraw.text(0.8, 0.8, "white text");
    }
