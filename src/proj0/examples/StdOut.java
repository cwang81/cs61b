/*************************************************************************
 *  Compilation:  javac proj0.StdOut.java
 *  Execution:    java proj0.StdOut
 *
...
public final class StdOut {
   ...
   /**
    ...
    public static void main(String[] args) {
        ...
        // write to stdout
        proj0.StdOut.println("Test");
        proj0.StdOut.println(17);
        proj0.StdOut.println(true);
        proj0.StdOut.printf("%.6f\n", 1.0/7.0);
    }
