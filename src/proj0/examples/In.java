/*************************************************************************
 *  Compilation:  javac proj0.In.java
 *  Execution:    java proj0.In   (basic test --- see source for required files)
 *
...
public final class In {
    ...
    /*** begin: section (1 of 2) of code duplicated from proj0.In to StdIn */
    ...
    /*** end: section (1 of 2) of code duplicated from proj0.In to StdIn */
   ...
   /**
    ...
    /*** begin: section (2 of 2) of code duplicated from proj0.In to StdIn,
   ...
   /**
    ...
    public char readChar() {
        ...
        assert (ch.length() == 1) : "Internal (Std)proj0.In.readChar() error!"
   ...
   /**
    ...
    /*** end: section (2 of 2) of code duplicated from proj0.In to StdIn */
   ...
   /**
     ...
     * <tt>new proj0.In(filename)</tt>.{@link #readAllInts()}
     */
    public static int[] readInts(String filename) {
        return new proj0.In(filename).readAllInts();
    }

   /**
     * Reads all doubles from a file
     * @deprecated Clearer to use 
     * <tt>new proj0.In(filename)</tt>.{@link #readAllDoubles()}
     */
    public static double[] readDoubles(String filename) {
        return new proj0.In(filename).readAllDoubles();
    }

   /**
     * Reads all strings from a file
     * @deprecated Clearer to use 
     * <tt>new proj0.In(filename)</tt>.{@link #readAllStrings()}
     */
    public static String[] readStrings(String filename) {
        return new proj0.In(filename).readAllStrings();
    }
    ...
    public static int[] readInts() {
        return new proj0.In().readAllInts();
    }
   ...
   /**
    ...
    public static double[] readDoubles() {
        return new proj0.In().readAllDoubles();
    }
   ...
   /**
    ...
    public static String[] readStrings() {
        return new proj0.In().readAllStrings();
    }
   ...
   /**
    ...
    public static void main(String[] args) {
        ...
        System.out.println("---------------------------------------------------------------------------");
        try {
            in = new proj0.In("../stdlib/InTest.txt");
            while (!in.isEmpty()) {
                String s = in.readLine();
                System.out.println(s);
            }
        ...
        System.out.println("---------------------------------------------------------------------------");
        in = new proj0.In("/n/fs/introcs/www/java/stdlib/InTest.txt");
        try {
            while (!in.isEmpty()) {
                String s = in.readLine();
                System.out.println(s);
        ...
        System.out.println("---------------------------------------------------------------------------");
        try {
            in = new proj0.In("G:\\www\\introcs\\stdlib\\InTest.txt");
            while (!in.isEmpty()) {
                String s = in.readLine();
                System.out.println(s);
            }
